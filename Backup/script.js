...
scrap = async (url) => {
  try {
    ...
    var extractor = await page.evaluate(() => {
        ...
        // var titleNodeList = document.querySelectorAll('.list-view-course-card--container--2fJ9s > .list-view-course-card--title--2pfA0 > h4');
        ...
        // Course URL
        // var urlNodeList = document.querySelectorAll('div.main-content > div > div > div:nth-child(12) > div:nth-child(2) > div:nth-child(1) > div > a');
...
// scrap('https://www.udemy.com/courses/search/?src=ukw&q=node+js');
scrap('https://www.udemy.com/topic/javascript/?p=1&persist_locale=&locale=en_US');
scrap('https://www.udemy.com/topic/javascript/?p=2&persist_locale=&locale=en_US');
scrap('https://www.udemy.com/topic/javascript/?p=3&persist_locale=&locale=en_US');
// scrap('https://www.udemy.com/topic/javascript/?p=4&persist_locale=&locale=en_US');
